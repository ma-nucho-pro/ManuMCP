...
function lookup(headers: Record<string, string>, name: string): string | undefined {
...
function mismatch(header: string, reason: "missing" | "mismatch"): HeaderResult {
    return {
        ok: false,
...
export function validateMirroredHeaders(headers: Record<string, string>, body: RequestBody, options: HeaderOptions = {}): HeaderResult {
