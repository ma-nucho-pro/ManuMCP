export declare const RESERVED_JSONRPC_RANGE: {
    readonly min: -32768;
    readonly max: -32000;
};
export declare const SPECIFICATION_SUBRANGE: {
    readonly min: -32099;
    readonly max: -32020;
};
export declare const RETIRED_CODES: readonly number[];
export declare const LDCH_ERROR_CODES: Readonly<{
...
export declare function assertCodeAllocationValid(codes: Readonly<Record<string, number>>): void;
