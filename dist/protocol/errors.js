export const RESERVED_JSONRPC_RANGE = { min: -32768, max: -32000 };
export const SPECIFICATION_SUBRANGE = { min: -32099, max: -32020 };
export const RETIRED_CODES = Object.freeze([-32002, -32042]);
...
export function assertCodeAllocationValid(codes) {
